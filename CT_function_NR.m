function [results]=CT_function(app,CT,filedir,graphname,detail,power,z,mu)
...
% --------------------------------------------------------------------
    ...
    if(showIrslice)
        ...
        ax = app.UIAxes_2;
        fig=figure;           
        title(app.UIAxes_2, t)
        xlabel(app.UIAxes_2, 'Radial Position [mm]')
        ...
        saveMirrorPlot(Ir_x,conc,savepath,mu);
    ...
    if(showdata)
       ...
       % plot(x,R(:,index),'x',scaling*x2,P2(:,index),'o');
        ...
        ax = app.UIAxes_2;
        fig=figure;           
        title(app.UIAxes_2, 'Projections')
        xlabel(app.UIAxes_2, 'Beam Offset [mm]')
        ylabel(app.UIAxes_2, 'Integrated Ray [Absorbance]')
        app.UIAxes_2.XGrid = 'off';
        app.UIAxes_2.YGrid = 'off';
        
        plot(ax,x,PIC,'x',scaling*x2,mean(PIC2,2),'o');
        legend(app.UIAxes_2,'Original PIC','Reconstructed PIC');
        
        savePICsSlice(x,PIC,scaling,x2,PIC2,savepath);
